            ...
            <div className="relative pt-16 pb-8 lg:pt-20 lg:pb-12 min-h-[calc(100vh-64px)] flex items-center overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
                    <div className="text-center max-w-5xl mx-auto">
                        ...
                        <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#fff] tracking-tight leading-tight mb-8 lg:mb-12">
                            Connecting the world through <span className="text-black">Technology</span>
                        </h1>
                        <br />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="group bg-[#f4f7f8] rounded-2xl p-8 border border-transparent hover:border-[#81d742] hover:bg-white hover:shadow-lg transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold text-[#00343C] mb-3">Managed IT Services</h3>
                        ...
                        <div className="group bg-[#f4f7f8] rounded-2xl p-8 border border-transparent hover:border-[#81d742] hover:bg-white hover:shadow-lg transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold text-[#00343C] mb-3">Digital Transformation Services</h3>
                            <p className="text-[#304040] leading-relaxed text-sm">
                        ...
                        <div className="group bg-[#f4f7f8] rounded-2xl p-8 border border-transparent hover:border-[#81d742] hover:bg-white hover:shadow-lg transition-all duration-300">
                            ...
                            <h3 className="text-lg font-bold text-[#00343C] mb-3">Design and UX Services</h3>
                            <p className="text-[#304040] leading-relaxed text-sm">
