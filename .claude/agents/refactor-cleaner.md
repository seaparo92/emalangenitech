...
context_loading:
  ...
  update: .claude/docs/api-contracts/ after API deletions
---
...
1. Check contract: `.claude/docs/api-contracts/contracts/[feature].contract.md`
2. Check if FE or BE counterpart exists
3. If both exist → Remove both or mark deprecated
4. If only one exists → Update pending docs
