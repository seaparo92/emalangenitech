...
```json
{
  "hooks": {
    "PreToolUse": [{
      ...
      "hooks": [{
        "type": "command",
        "command": "~/.claude/skills/auto-learning/hooks/observe.sh pre"
      }]
    }],
    "PostToolUse": [{
      "matcher": "*",
      "hooks": [{
        "type": "command",
        "command": "~/.claude/skills/auto-learning/hooks/observe.sh post"
      }]
    }]
  }
}
...
~/.claude/skills/auto-learning/agents/start-observer.sh
```
