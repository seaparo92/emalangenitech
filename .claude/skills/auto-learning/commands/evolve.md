...
command: /evolve
implementation: python3 ~/.claude/skills/auto-learning/scripts/instinct-cli.py evolve
---
...
```bash
python3 ~/.claude/skills/auto-learning/scripts/instinct-cli.py evolve [--generate]
```
