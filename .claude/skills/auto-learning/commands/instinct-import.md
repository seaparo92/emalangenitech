...
implementation: python3 ~/.claude/skills/auto-learning/scripts/instinct-cli.py import <file>
---
...
```bash
python3 ~/.claude/skills/auto-learning/scripts/instinct-cli.py import <file-or-url> [--dry-run] [--force] [--min-confidence 0.7]
```
